...
class RadiumConfig(models.Model):
    ...
    colt_id_width = models.PositiveSmallIntegerField(null=True, blank=True, default=200)
    colt_id_textsize = models.PositiveSmallIntegerField(null=True, blank=True, default=15)
    colt_id_visible = models.BooleanField(default=True)
...
class Work(models.Model):
    ...
    description_last_editor = models.ForeignKey('Profile', on_delete=models.CASCADE, null=True, blank=True, related_name='description_last_editor')
    description_previous_value = models.TextField(null=True, blank=True)
    ...
    note_last_editor = models.ForeignKey('Profile', on_delete=models.CASCADE, null=True, blank=True, related_name='note_last_editor')
    note_previous_value = models.TextField(null=True, blank=True)
    ...
    ilt_last_editor = models.ForeignKey('Profile', on_delete=models.CASCADE, null=True, blank=True, related_name='ilt_last_editor')
    ilt_previous_value = models.TextField(null=True, blank=True)
    ...
    upm_last_editor = models.ForeignKey('Profile', on_delete=models.CASCADE, null=True, blank=True, related_name='upm_last_editor')
    upm_previous_value = models.TextField(null=True, blank=True)
    ...
    status_last_editor = models.ForeignKey('Profile', on_delete=models.CASCADE, null=True, blank=True, related_name='status_last_editor')
    status_previous_value = models.TextField(null=True, blank=True)
    ...
    zkl_last_editor = models.ForeignKey('Profile', on_delete=models.CASCADE, null=True, blank=True, related_name='zkl_last_editor')
    zkl_previous_value = models.TextField(null=True, blank=True)
    ...
    cascat_last_editor = models.ForeignKey('Profile', on_delete=models.CASCADE, null=True, blank=True, related_name='cascat_last_editor')
    cascat_previous_value = models.TextField(null=True, blank=True)
    ...
    grue_last_editor = models.ForeignKey('Profile', on_delete=models.CASCADE, null=True, blank=True, related_name='grue_last_editor')
    grue_previous_value = models.TextField(null=True, blank=True)
    ...
    osv_last_editor = models.ForeignKey('Profile', on_delete=models.CASCADE, null=True, blank=True, related_name='osv_last_editor')
    osv_previous_value = models.TextField(null=True, blank=True)
    ...
    loco_last_editor = models.ForeignKey('Profile', on_delete=models.CASCADE, null=True, blank=True, related_name='loco_last_editor')
    loco_previous_value = models.TextField(null=True, blank=True)
    ...
    hgs_last_editor = models.ForeignKey('Profile', on_delete=models.CASCADE, null=True, blank=True, related_name='hgs_last_editor')
    hgs_previous_value = models.TextField(null=True, blank=True)
    ...
    soudure_last_editor = models.ForeignKey('Profile', on_delete=models.CASCADE, null=True, blank=True, related_name='soudure_last_editor')
    soudure_previous_value = models.TextField(null=True, blank=True)
    ...
    pn_last_editor = models.ForeignKey('Profile', on_delete=models.CASCADE, null=True, blank=True, related_name='pn_last_editor')
    pn_previous_value = models.TextField(null=True, blank=True)
    ...
    art_last_editor = models.ForeignKey('Profile', on_delete=models.CASCADE, null=True, blank=True, related_name='art_last_editor')
    art_previous_value = models.TextField(null=True, blank=True)
    ...
    s428_last_editor = models.ForeignKey('Profile', on_delete=models.CASCADE, null=True, blank=True, related_name='s428_last_editor')
    s428_previous_value = models.TextField(null=True, blank=True)
    ...
    s461_last_editor = models.ForeignKey('Profile', on_delete=models.CASCADE, null=True, blank=True, related_name='s461_last_editor')
    s461_previous_value = models.TextField(null=True, blank=True)
    ...
    atwtx_last_editor = models.ForeignKey('Profile', on_delete=models.CASCADE, null=True, blank=True, related_name='atwtx_last_editor')
    atwtx_previous_value = models.TextField(null=True, blank=True)
    ...
    imputation_last_editor = models.ForeignKey('Profile', on_delete=models.CASCADE, null=True, blank=True, related_name='imputation_last_editor')
    imputation_previous_value = models.TextField(null=True, blank=True)
    ...
    extra_last_editor = models.ForeignKey('Profile', on_delete=models.CASCADE, null=True, blank=True, related_name='extra_last_editor')
    extra_previous_value = models.TextField(null=True, blank=True)
    ...
    scst_last_editor = models.ForeignKey('Profile', on_delete=models.CASCADE, null=True, blank=True, related_name='scst_last_editor')
    scst_previous_value = models.TextField(null=True, blank=True)
    ...
    colt_id_last_editor = models.ForeignKey('Profile', on_delete=models.CASCADE, null=True, blank=True, related_name='colt_id_last_editor')
    colt_id_previous_value = models.TextField(null=True, blank=True)
